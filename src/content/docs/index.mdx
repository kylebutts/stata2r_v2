...
1. Data wrangling (🗄🧹) with [**data.table**](stata2r_v2/data.table/)
2. Regression analysis (💻📈) with [**fixest**](stata2r_v2/fixest/)

There are [**other great R packages**](stata2r_v2/extras/) that work well and are easy to
